...
def insertion(inputnum):
    for i in range(1, len(inputnum)):
        temp = inputnum[i]
        j = i - 1
        while (j >= 0 and temp < inputnum[j]):
...
def checkTime(arr1, arr2, arr3, func) :
    ...
    ans1 = func(arr1)
    endTime1 = time.time()
    elapsedTime1 = (endTime1 - startTime1) * 10**6
    ...
    ans2 = func(arr2)
    endTime2 = time.time()
    elapsedTime2 = (endTime2 - startTime2) * 10**6
    ...
    ans3 = func(arr3)
    endTime3 = time.time()
    elapsedTime3 = (endTime3 - startTime3) * 10**6
...
# a1, b1, c1, d1, e1, f1 = makeArr(100, a1), makeArr(100, b1), makeArr(100, c1), makeArr(100, d1), makeArr(100, e1), makeArr(100, f1)
# a2, b2, c2, d2, e2, f2 = makeArr(1000, a2), makeArr(1000, b2), makeArr(1000, c2), makeArr(1000, d2), makeArr(1000, e2), makeArr(1000, f2)
# a3, b3, c3, d3, e3, f3 = makeArr(10000, a3), makeArr(10000, b3), makeArr(10000, c3), makeArr(10000, d3), makeArr(10000, e3), makeArr(10000, f3)
a1 = makeArr(100, a1)
a2 = makeArr(1000, a2)
a3 = makeArr(10000, a3)
